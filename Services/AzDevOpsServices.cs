...
namespace Services
{
    public class AzDevOpsServices : IAzDevOpsServices
    {
        private readonly HttpClient _client;
        private readonly ILogger _log;
        private readonly IOptions<AzAdOptions> _azAdOptions;

        public AzDevOpsServices(HttpClient httpClient, IOptions<AzAdOptions> azAdOptions, ILogger log)
        {
        ...
        public async Task<HttpResponseMessage> GetProjects(string requestBody, ILogger log)
        {
